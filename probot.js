...
if(message.content.startsWith(prefix + 'تحرك')) {
 ...
 return message.channel.send("``لاستخدام الأمر اكتب هذه الأمر : " +prefix+ "تحرك [USER]``")
}
...
[❖═════ General Commands ═══════❖]
 ...
 -id 
 معلومات عن حسابك الشخصي

 سيرفر
 معلومات حول السيرفر
 
تحرك 
 سحب عضو الى رومك الصوتي

 مسح 
 مسح الرسائل الموجوده في الروم بعدد

 -avatar
 يعرض اك صورتك الشخصية
 
 صورة
 يعرض لك صورة السيرفر
 
 -credit
 يوريك كم الكريديت حقتك
...
بان 
 ...
 اسكت
 اعضاء ميوت كتابي لعضو في السيرفر
 
 تكلم
 فك الميوت عن عضو في السيرفر
 
 #dac 
 حذف جميع رومات السيرفر
 
 #dar
 حذف جميع رتب السيرفر
 
 فتح 
 فتح المحادثة في الروم
 
قفل
 قفل المحادثة في الرةوم

 -role 
اعطاء رتبه لشخض معين
 ...
 -role all
 اعطاء رتبه للجميع سواء بشر او بوتات
